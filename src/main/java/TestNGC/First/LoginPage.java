...
public class LoginPage {
	...
	WebElement forgottenPassPage;
	
	public String ForgottenPassPageContent()
	{
		return forgottenPassPage.getText();
	}

	public boolean ForgottenPassisDisplay()
	{
		return ForgottenPass.isDisplayed();
	}
